...
2) Features are then extracted from the images. they are the hue and saturation values of the faces. ![](K_means clustering 1.png)
3) Then K_means clustering is applied to the faces. ![](K_means clustering 2.png)
4) We then add a template image and repeat the same process on it. We then plot its K_means cluster location: ![](K_means clustering 3.png)
